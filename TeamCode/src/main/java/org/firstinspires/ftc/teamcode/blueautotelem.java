...
public class blueautotelem extends LinearOpMode {
...
//            Imgproc.rectangle(input, region1_pointA, region1_pointB, BLUE, 2);
            ...
            position = blueautotelem.Thing.CapPosition.A;
            if ((avg2<=avg3)&&(avg2<=122)){
                position = blueautotelem.Thing.CapPosition.B;
            }
            else if ((avg3<avg2)&&(avg3<122)){
                position = blueautotelem.Thing.CapPosition.C;
            }
            else {
                position = blueautotelem.Thing.CapPosition.A;
            }
